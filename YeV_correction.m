...
delta=h*g./wind.^2;
chi=fetch*g./wind.^2;
%chi_corrected=(afetch*fetch)*g./wind.^2;

%epsilon=3.64*10^-3*(tanh(0.493*delta.^0.75).*tanh(3.13*10^-3*chi.^0.57./tanh(0.493*delta.^0.75))).^1.74;
epsilon=3.64*10^-3*(tanh(0.493*delta.^0.75).*tanh(4*10^-3*chi.^0.57./tanh(0.493*delta.^0.75))).^1.74;
%epsilon=3*10^-8*chi.^(2.7*(chi./delta).^-0.1);%   (tanh(0.493*delta.^0.75).*tanh(4*10^-3*chi.^0.57./tanh(0.493*delta.^0.75))).^1.74;
