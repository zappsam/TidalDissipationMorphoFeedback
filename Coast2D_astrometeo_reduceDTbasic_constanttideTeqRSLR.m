...
%Sea level rise
P.RSLR=4.5/1000/365;  %from mm/yr to m/day (the time unit is the day!)
...
P.calculateponddynamics=1;
    ...
    P.minponddepth=0.2;%1; %minimum depth to define a pond after you identified the "lakes"
...
%Time parameters
tmax=400*1;%10000;%2000;%400;%2*199;%1000;%149;%1000;%149;%2000;%3000;%50;%42/2-1;%2000;%1250;% number of time steps
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%time series
numberserie=80*5;%2000;%2000;%10000;%if you change this you will change the actual values in the time series, rememebr!
...
load STORE152.mat
zbed=STORE152(:,:,94);
msl=3/1000*1880;%%%%%yr 2500 starting
z=zbed+msl;
...
%save STORE STORE
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst152_RSLR6');