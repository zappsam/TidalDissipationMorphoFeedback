...
%gC=[40 20 10 5 40 20 10 5 40 20 10 5 40 20 10 5];
...
P.DoMUD=0.5;%10;%base diffusivity of suspedned mud [m2/s]. Process not related to tides (e.g. wind and waves, other ocean circulation)
...
P.Trange=3;%0.7;%1.4;%0.5;%0.8;%1.4; %mean tidal Trange [m]
...
P.maxedgeheight=2;
P.fox=0.2;%fraction of edge eroded material that is oxidized. 20% is oxydices (=lost)
...
P.alphaMUD=0.5;%*0.1;%0.1;%1; %coefficient for bedload downslope of mud. added April 2019. Similar to P.alphaSAND
...
P.calculateponddynamics=1;%1;
    ...
    P.minponddepth=0.1;%0.05;%1; %minimum depth to define a pond after you identified the "lakes"
    ...
    %%
    P.aPEXP=0.015*1;%isolated pond expansion rate m/yr
...
%Time parameters
tmax=149;%1000;%149;%2000;%3000;%50;%42/2-1;%2000;%1250;% number of time steps
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%time series
numberserie=2000;%2000;%2000;%10000;%if you change this you will change the actual values in the time series, rememebr!
...
%savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'mudflta_r3');
...
%v=VideoWriter('r3R1Co40___R7_Co5','Motion JPEG AVI');
