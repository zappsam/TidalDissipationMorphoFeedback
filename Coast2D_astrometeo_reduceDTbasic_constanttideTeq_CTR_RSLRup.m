...
%Sea level rise
P.RSLR=4/1000/365;  %from mm/yr to m/day (the time unit is the day!)
...
v=VideoWriter('tst180v3_newgtr_v3_CTRRSLRup');
...
STORE180v3_CTR_RSLR4t1200=STORE;
...
save STORE180v3_CTR_RSLR4t1200 STORE180v3_CTR_RSLR4t1200
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst180v3_newgtr_v3_CTR_RSLR4_t1200');