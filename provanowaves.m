...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
P=struct;
STORE_t200_r07_nopondnowave=zeros(500,300,16);
% 
...
P.Trange=0.7;%0.7;%1.4;%0.5;%0.8;%1.4; %mean tidal Trange [m]
...
%Edge erosion
P.aw=0*0.3/365; %wave edge erodability m/yr/W/m2
P.maxedgeheight=2;
...
%Time parameters
tmax=99;%1000;%149;%1000;%149;%2000;%3000;%50;%42/2-1;%2000;%1250;% number of time steps
...
%savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'base_pozzex10nopond');
...
STORE_t200_r07_nopondnowave(:,:,contatore)=zbed;
