...
slope=0.3/1000;z=[0:N-1]*slope*dx;z=z'*ones(1,M)-3;%sloping   0.5
...
% %REFINE GRID
% dx=100;
% z=interp2([0:N-1],[0:M-1]',z',[0:0.5:N-1],[0:0.5:M-1]','linear')';A=interp2([0:N-1],[0:M-1]',A',[0:0.5:N-1],[0:0.5:M-1]','nearest')';
% [N,M]=size(z);
% x=[0:N-1]*dx/1000;y=[0:M-1]*dx/1000;

% %REFINE GRID
% dx=50;
% z=interp2([0:N-1],[0:M-1]',z',[0:0.25:N-1],[0:0.25:M-1]','linear')';A=interp2([0:N-1],[0:M-1]',A',[0:0.25:N-1],[0:0.25:M-1]','nearest')';
% [N,M]=size(z);
% x=[0:N-1]*dx/1000;y=[0:M-1]*dx/1000;


% [N,M]=size(z);
% dx=100;z=interp2([0:N-1],[0:M-1]',z',[0:0.5:N-1],[0:0.5:M-1]','nearest')';
% [N,M]=size(z);
% %%%%%%%%%%%cell types
% A=ones(N,M);
% %sea b.c.
