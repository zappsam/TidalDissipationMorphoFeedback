...
%figure;imagesc(z);caxis([-2 2]);pause
...
load BWsottocornerNWG
A(BWsottocornerNWG==1)=0;
...
%giugno 2018
%A=A(1:1:405,400:1010);
%z=z(1:1:405,400:1010);
...
%figure;imagesc(z);set(gca,'YDir','normal')
%pause
...
% %cut the channel near the inlet
% z(140:141,470:500)=0.4;
% z(131:139,470:500)=-1.5;
