...
P.co2=25/1000;%40/1000; %Sea boundary SSC for mud [g/l]
...
%Time parameters
tmax=1500*1;%10000;%2000;%400;%2*199;%1000;%149;%1000;%149;%2000;%3000;%50;%42/2-1;%2000;%1250;% number of time steps
...
%load CASAr07%NOPOND
%load CASAr07
load tst180v3_newgtr_v3_CTR.mat
load STORE180v3_CTR.mat
zbed=STORE180v3_CTR(:,:,80);
msl=3/1000*1600;%%%%%yr 2500 starting
z=zbed+msl;
...
v=VideoWriter('tst180v3_newgtr_v3_CTRCodown');
%v=VideoWriter('ZsillEgdeERhoastrometeoDT02yrvariableTide_wavemeantideBIS_edgerosionhwave','Motion JPEG AVI');

STOREXXTide2_v3_CTR=zeros(4,15000);
STOREVTRinputs_v3_CTR=zeros(5,15000);
%%%%%%%%%%%%%%%%%%%%%%MAIN LOOP%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
STOREVTRinputs_v3_CTR(:,t)=VTRcomponents;
...
while dti<dto;
    firstattemp=1;maxdeltaz=limitdeltaz+1;maxup=limitmaxup+1;
        ...
        [IOtemp,fIOtemp,maxdeltaz,maxup,PLT]=mainevolutionstep_CTR(A,AW,SPCLcell,P,x,dx,dt,zb,IO,fIO,Hsurge,angleSWELL,angleWIND,t);
...
STOREXXTide2_v3_CTR(:,t)=PLT.XXTide2;
...
STORE180v3_CTR_CO25t1600=STORE;

end; %end of panel plotting
if makevideo==1;close(v);end %UNCOMMENT THIS TO CREATE A VIDEO
%save STOREXXTide2_v3_CTR STOREXXTide2_v3_CTR
%save STOREVTRinputs_v3_CTR STOREVTRinputs_v3_CTR
save STORE180v3_CTR_CO25t1600 STORE180v3_CTR_CO25t1600
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst180v3_newgtr_v3_CTR_CO25_t1600');