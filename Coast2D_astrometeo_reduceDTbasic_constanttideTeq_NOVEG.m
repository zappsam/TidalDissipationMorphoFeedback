...
%Time parameters
tmax=15000*1;%10000;%2000;%400;%2*199;%1000;%149;%1000;%149;%2000;%3000;%50;%42/2-1;%2000;%1250;% number of time steps
...
v=VideoWriter('tst180v3_newgtr_v3_NOVEG');
%v=VideoWriter('ZsillEgdeERhoastrometeoDT02yrvariableTide_wavemeantideBIS_edgerosionhwave','Motion JPEG AVI');

STOREXXTide2_v3_NOVEG=zeros(4,15000);
STOREVTRinputs_v3_NOVEG=zeros(5,15000);
%%%%%%%%%%%%%%%%%%%%%%MAIN LOOP%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
STOREVTRinputs_v3_NOVEG(:,t)=VTRcomponents;
...
while dti<dto;
    firstattemp=1;maxdeltaz=limitdeltaz+1;maxup=limitmaxup+1;
        ...
        [IOtemp,fIOtemp,maxdeltaz,maxup,PLT]=mainevolutionstep_noveg(A,AW,SPCLcell,P,x,dx,dt,zb,IO,fIO,Hsurge,angleSWELL,angleWIND,t);
...
STOREXXTide2_v3_NOVEG(:,t)=PLT.XXTide2;
...
save STOREXXTide2_v3_NOVEG STOREXXTide2_v3_NOVEG
save STOREVTRinputs_v3_NOVEG STOREVTRinputs_v3_NOVEG
save STORE180v3_newgtr_v3_NOVEG STORE
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst180v3_newgtr_v3_NOVEG');