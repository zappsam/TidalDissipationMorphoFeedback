function [deltaY1,deltaY2,deltaY3,Pedge,Y2OX,EdgeERY1,EdgeERY2,EdgeERY3]=EdgeerosionXXX(Pedge,z,aw,maxedgeheight,fox,dt,dx,MASK,A,fracY1,fracY2,fracY3,Y2OX);

%MASK 1 are the channel with flow
%MASK 2 is where the are no waves


%Pedge(MASK==1)=0;%the wave power in the mudflat becomes zero!

%figure;imagesc(Pedge');pause
