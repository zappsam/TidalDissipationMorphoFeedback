%This is code is set up to run the simulation presented in Figure 2 or
%"Tidal dissipation morphodynamic feedback triggers loss of microtidal
%marshes" by Zapp & Mariotti (2024).
...
v=VideoWriter('Fig2simulation_ZappandMariotti2024');
...
% save STORE180v3_newgtr_v3 STORE180v3_newgtr_v3
% savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'Fig2simulation_ZappandMariotti2024');