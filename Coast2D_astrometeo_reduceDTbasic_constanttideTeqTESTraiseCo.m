...
%Edge erosion
P.aw=0.5/365; %wave edge erodability m/yr/W/m2
P.maxedgeheight=2;
...
P.co2=70/1000;%40/1000; %Sea boundary SSC for mud [g/l]
...
%Time parameters
tmax=1000*1;%10000;%2000;%400;%2*199;%1000;%149;%1000;%149;%2000;%3000;%50;%42/2-1;%2000;%1250;% number of time steps
...
load STORE168
zbed=STORE168(:,:,150);
msl=3/1000*2500;%%%%%yr 2500 starting
z=zbed+msl;
...
%save STORE STORE
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst168Co70');