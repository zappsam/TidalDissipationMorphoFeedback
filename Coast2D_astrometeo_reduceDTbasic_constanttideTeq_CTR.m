...
v=VideoWriter('tst180v3_newgtr_v3_CTR');
...
save STORE180v3_CTR STORE
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst180v3_newgtr_v3_CTR');