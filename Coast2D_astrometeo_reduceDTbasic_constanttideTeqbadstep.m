...
%load CASAr07%NOPOND
%load CASAr07
load tst180v3_newgtr.mat
load STORE180v3_newgtr.mat
zbed=STORE180v3_newgtr(:,:,51);
msl=3/1000*1020;%%%%%yr 2500 starting
z=zbed+msl;
...
STOREVTRinputs(:,t)=VTRcomponents;
...
save STOREXXTide2 STOREXXTide2
%save STORE STORE
savegeometry_3sediments(N,M,dx,A,AW,Yb,plyr,zb,z,Y1,Y2,Y3,flyr1,flyr2,flyr3,flyrb1,flyrb2,flyrb3,Active,x,y,msl,SPCLcell,'tst180v3_newgtr_v3');